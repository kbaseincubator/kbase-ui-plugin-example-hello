...
export interface FakeIFrameProps {
    // params: object;
    // channelId: string;
    pathRoot: string;
    token: string;
...
interface IFakeIFrameState {}

export default class FakeIFrame extends React.Component<FakeIFrameProps, IFakeIFrameState> {
    // origin: string;
    // pathRoot: string
    id: string;
    // url: string;
    ...
    constructor(props: FakeIFrameProps) {
        super(props);
    ...
    render() {
        const params = encodeURIComponent(
            JSON.stringify({
                ...
                params: this.props.pluginParams,
        ...
        return (
            <div className="IFrame">
                <div
                    className="FakeIFrame-pluginHost"
                    ref={this.iframeRef}
                    id="plugin-host"
                    title={this.id}
